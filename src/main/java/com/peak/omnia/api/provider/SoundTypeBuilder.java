 ...
 *
 * <p>Use in conjunction with {@link ModdedSoundsProvider} to generate sound definitions.
 *
...
public interface SoundTypeBuilder {
    ...
    static SoundTypeBuilder of(SoundEvent event) {
        ...
        return of().subtitle(Util.createTranslationKey("subtitles", event.getId()));
    }
    ...
    default SoundTypeBuilder category(SoundCategory category) {
        return this;
    }
